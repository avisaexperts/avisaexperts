    ...
    <div class="profile-section">
        ...
        ?>
                ...
                <div class="profile-info">
                    ...
                    <h2><?= $value['name']; ?> <span class="status-active"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13"
                                viewBox="0 0 13 13" fill="none">
                                <circle cx="6.43564" cy="6.5001" r="6.43564" fill="#3ED33E" />
                            </svg> Active</span></h2>
                    <p class="job-title"><?= $value['expertise']; ?> consultants</p>
                    ...
                    <div id="htmlModal" class="modal">
                        ...
                        <div class="modal-content">
                            ...
                            <p>You need a minimum balance of ₹120 (for 5 minutes) to <br> start a chat with our consultant.
                            </p>
                            <div class="popupbtns">
                                <button class="cancelbtn"><a href="nextconsultant.php">Cancel</a></button> <button
                                    class="rechargebtn"><a href="recharge.php">Recharge</a></button>
                            </div>
                        </div>
                    </div>
                    <div class="actions">
                        <div class="services-final-call-con">
                            <div class="service-option">
                                ...
                                <div class="button chat">
                                    ...
                                    <div class="label"><a href="userchat.php?aid=<?= $agentId; ?>">chat</a></div>
                                </div>
                            </div>
                            <div class="service-option">
                                <div class="price-info">
                            ...
                            <div class="service-option">
                                ...
                                <div class="button video vediolabel">
                                    <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="25"
                                            viewBox="0 0 24 25" fill="none">
                                            <path
