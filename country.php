...
<div class="hero-section">
      <img src="countryimages/herobgcountry.jpg" alt="" />
    </div>
    ...
    <section class="region-grid">
      ...
      <div class="region-card">
        <div class="image-overlay">
          <img src="countryimages/image 52.jpg" alt="Europe" />
      ...
      <div class="region-card">
        <div class="image-overlay">
          <img src="countryimages/image 53.jpg" alt="South America" />
          <div class="overlay-text">
            <h2>SOUTH AMERICA</h2>
            <button class="learn-more">Learn More</button>
          </div>
      ...
      <div class="region-card">
        <div class="image-overlay">
          <img src="countryimages/image 54.jpg" alt="Africa" />
          <div class="overlay-text">
            <h2>AFRICA</h2>
            <button class="learn-more">Learn More</button>
          </div>
      ...
      <div class="region-card">
        <div class="image-overlay">
          <img src="countryimages/image 55.jpg" alt="Asia" />
          <div class="overlay-text">
            <h2>ASIA</h2>
            <button class="learn-more">Learn More</button>
          </div>
      ...
      <div class="region-card">
        <div class="image-overlay">
          <img src="countryimages/image.jpg" alt="North America" />
          <div class="overlay-text">
            <h2>NORTH AMERICA</h2>
            <button class="learn-more">Learn More</button>
          </div>
      ...
      <div class="region-card">
        <div class="image-overlay">
          <img src="countryimages/image (1).jpg" alt="Oceania" />
          <div class="overlay-text">
            <h2>OCEANIA</h2>
            <button class="learn-more">Learn More</button>
          </div>
      ...
      <div class="countries-container">
        ...
        <div class="country-list">
          <div class="country-item">
            <img
              src="countryimages/8687cbee1eec918557b65c3ede6d967a.png"
              alt="Austria Flag"
            />
            <span>Austria</span>
          </div>
          <div class="country-item">
            <img
              src="countryimages/belgiumimg.png"
              alt="Belgium Flag"
            />
            <span>Belgium</span>
          </div>
          <div class="country-item">
            <img
              src="countryimages/6c44817710339cff68f652c23aebbd1a.png"
