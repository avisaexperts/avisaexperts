...
<div class="hero-section">
  <img src="https://res.cloudinary.com/dtjgawrwz/image/upload/v1733821940/herobgcountry_f7nc1h.jpg" alt="" />
</div>
<div class="country-offering-visa">
  <h3>Countries Offering Visa Services</h3>
</div>
<section class="region-grid">
  <!-- Europe Card -->
  <div class="region-card">
    <div class="image-overlay">
      <img src="https://res.cloudinary.com/dtjgawrwz/image/upload/v1733821951/image_52_gdgkyl.jpg" alt="Europe" />
      <div class="overlay-text">
        <h2>EUROPE</h2>
        <button class="learn-more">Learn More</button>
      </div>
    </div>
    <span class="country-count">10 countries</span>
  </div>

  <!-- South America Card -->
  <div class="region-card">
    <div class="image-overlay">
      <img src="https://res.cloudinary.com/dtjgawrwz/image/upload/v1733821908/image_53_jtkava.jpg" alt="South America" />
      <div class="overlay-text">
        <h2>SOUTH AMERICA</h2>
        <button class="learn-more">Learn More</button>
      </div>
  ...
  <div class="region-card">
    <div class="image-overlay">
      <img src="https://res.cloudinary.com/dtjgawrwz/image/upload/v1733821909/image_54_bgs4hv.jpg" alt="Africa" />
      <div class="overlay-text">
        <h2>AFRICA</h2>
        <button class="learn-more">Learn More</button>
      </div>
  ...
  <div class="region-card">
    <div class="image-overlay">
      <img src="https://res.cloudinary.com/dtjgawrwz/image/upload/v1733821950/image_55_uqi9tn.jpg" alt="Asia" />
      <div class="overlay-text">
        <h2>ASIA</h2>
        <button class="learn-more">Learn More</button>
      </div>
  ...
  <div class="region-card">
    <div class="image-overlay">
      <img src="https://res.cloudinary.com/dtjgawrwz/image/upload/v1733821958/imgbackgroundslider_haqfky.jpg" alt="North America" />
      <div class="overlay-text">
        <h2>NORTH AMERICA</h2>
        <button class="learn-more">Learn More</button>
      </div>
  ...
  <div class="region-card">
    <div class="image-overlay">
      <img src="https://res.cloudinary.com/dtjgawrwz/image/upload/v1733821949/image_1_kspwjc.jpg" alt="Oceania" />
      <div class="overlay-text">
        <h2>OCEANIA</h2>
        <button class="learn-more">Learn More</button>
      </div>
...
<div class="visa-section">
  <div class="search-country-container">
    <div class="search-country-bar">
      <input type="text" class="search-country-input" placeholder="Search your country">
      <svg class="search-country-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <circle cx="11" cy="11" r="8"></circle>
        <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
      </svg>
    </div>
  </div>
  <h1>Getting a Visa to Visit European Countries</h1>
  ...
  <div class="countries-container">
    ...
    <div class="country-list">
      <div class="country-item">
        <img
          src="https://res.cloudinary.com/dtjgawrwz/image/upload/v1733821919/8687cbee1eec918557b65c3ede6d967a_pcck5y.png"
          alt="Austria Flag" />
        <span>Austria</span>
      </div>
      <div class="country-item">
        <img
          src="https://res.cloudinary.com/dtjgawrwz/image/upload/v1733821952/belgiumimg_ged8sf.png"
          alt="Belgium Flag" />
        <span>Belgium</span>
      </div>
      <div class="country-item">
        <img
          src="https://res.cloudinary.com/dtjgawrwz/image/upload/v1733821937/6c44817710339cff68f652c23aebbd1a_wyzhp7.png"
...
<div class="why-choose-us">
  ...
  <div class="feature-cards">
    <div class="feature-card">
      <h3>INNOVATION</h3>
      <p>Visa Experts lets you know if you need a tourism/business visa. The application process is quick and
        easy.</p>
    </div>
    <div class="feature-card">
      <h3>SIMPLICITY</h3>
      <p>One central place to process all your visas online. Your data can be used for recurring applications
        with one click.</p>
    </div>
    <div class="feature-card">
      <h3>SECURITY</h3>
      <p>World-class data centers and methods for securing accounts. Your credit card data is not exposed to
        government websites.</p>
    </div>
    <div class="feature-card">
      <h3>ACCESSIBLE</h3>
      <p>Use from any device. Get last-minute visas with our user-friendly website.</p>
    </div>
  </div>
</div>
<div class="bothfaqandform">
  <div class="container my-5">
    <div class="row flex-collumn-f">
      <!-- FAQs Section -->
      <div class="col-md-6">
