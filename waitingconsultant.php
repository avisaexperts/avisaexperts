    ...
    <div class="profile-section">
        <div class="outeriprofilesec">
            ...
            <div class="rating">
                <p> 2796 orders</p>
                <p>⭐️⭐️⭐️⭐️⭐️</p>
                <div class="wait-timing">Wait - 10m</div>
            </div>
        </div>
        <div class="profile-info">
            <h2>Urvasikha <span class="status-active"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13"
                        viewBox="0 0 13 13" fill="none">
                        <circle cx="6.43564" cy="6.5001" r="6.43564" fill="#3ED33E" />
                    </svg> Active</span></h2>
            <p class="job-title">UK visa consultants</p>
            <p class="languages">English, Hindi, Punjabi</p>
            <p class="experience">Exp: 5 Years</p>
            <div class="verified">
            ...
            <div id="htmlModal" class="modal">
                ...
                <div class="modal-content">
                    ...
                    <p>Our consultant is busy right now. Please try again later or you can wait a moment.
                    </p>
                    <div class="popupbtns">
                        <button class="cancelbtn"><a href="waitingconsultant.php">Cancel</a></button>
                    </div>
                </div>
            </div>
            <div class="actions">
                <div class="services-final-call-con">
                    <div class="service-option">
                        ...
                        <div class="button waiting-btn  chat">
                    ...
                    <div class="service-option">
                        ...
                        <div class="button waiting-btn call">
                            <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="25"
                                    viewBox="0 0 24 25" fill="none">
                                    <path
                    ...
                    <div class="service-option">
                        <div class="price-info">
                            <div class="price-current">₹20/min</div>
                            <div class="price-original">₹60/min</div>
                        </div>
                        <div class="button waiting-btn video vediolabel">
                            <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="25"
                                    viewBox="0 0 24 25" fill="none">
                                    <path
