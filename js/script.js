...
// });
 ...
 document.querySelector('.raise-complaint-btn').addEventListener('click', function() {
  const complaintContainer = document.getElementById('complaintFormContainer');
  complaintContainer.style.display = (complaintContainer.style.display === 'none' || complaintContainer.style.display === '') ? 'block' : 'none';
});
...
document.getElementById("complaintForm").addEventListener("submit", function(event) {
  ...
  if (name && email && subject && complaint) {
      ...
      document.getElementById('complaintFormContainer').style.display = 'none';  // Hide form after submission
  } else {
