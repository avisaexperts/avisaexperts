...
<head>
    ...
    <link rel="stylesheet" href="css/chatdash.css">
    <link rel="stylesheet" href="css/chatdashboard.css">
    <link rel="stylesheet" href="css/voicecall.css">
    <link rel="stylesheet" href="css/calldash.css">
                ...
                <li class="nav-item" data-tab="schedule">
                    ...
                    <a href="taskdash.php">
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
                            <path d="M8.66428 17.3307H12.9976M8.66428 11.9141H17.3309M8.12478 3.78906C6.43911 3.83998 5.43486 4.0274 4.73936 4.7229C3.78711 5.67623 3.78711 7.20915 3.78711 10.2761V17.3242C3.78711 20.3922 3.78711 21.9251 4.73936 22.8785C5.69053 23.8307 7.22344 23.8307 10.2871 23.8307H15.7038C18.7685 23.8307 20.3004 23.8307 21.2515 22.8774C22.2049 21.9251 22.2049 20.3922 22.2049 17.3242V10.2761C22.2049 7.21023 22.2049 5.67623 21.2515 4.7229C20.5571 4.0274 19.5518 3.83998 17.8661 3.78906" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M8.12109 4.0599C8.12109 3.0134 8.97043 2.16406 10.0169 2.16406H15.9753C16.4781 2.16406 16.9603 2.3638 17.3158 2.71934C17.6714 3.07488 17.8711 3.55709 17.8711 4.0599C17.8711 4.5627 17.6714 5.04491 17.3158 5.40045C16.9603 5.75599 16.4781 5.95573 15.9753 5.95573H10.0169C9.51412 5.95573 9.03191 5.75599 8.67637 5.40045C8.32083 5.04491 8.12109 4.5627 8.12109 4.0599Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                        <span class="nav-text">Task</span>
                    </a>
                </li>
                <li class="nav-item active" data-tab="activities">
                    <b></b>
                    <b></b>
                ...
                <div class="container">
                    ...
                    <div class="profile-card">
                        ...
                        <div class="info-section-consultant">
                            ...
                            <div style="text-align: center;"><a href="#">Logout</a></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="for-padding-left">
                ...
                <div class="outer-chat-interface">
                    <div class="chat-section-con">
                            ...
                            <div class="chat-fixing">
                                ...
                                <div class="input-search">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28"
                                        fill="none">
                                        <path
                                            d="M21.0388 19.3872L26.0356 24.3828L24.3848 26.0336L19.3891 21.0368C17.5303 22.5269 15.2183 23.3374 12.8359 23.334C7.03994 23.334 2.33594 18.63 2.33594 12.834C2.33594 7.03798 7.03994 2.33398 12.8359 2.33398C18.6319 2.33398 23.3359 7.03798 23.3359 12.834C23.3393 15.2163 22.5289 17.5283 21.0388 19.3872ZM18.6984 18.5215C20.1788 16.9986 21.0056 14.9577 21.0026 12.834C21.0026 8.32248 17.3474 4.66732 12.8359 4.66732C8.32444 4.66732 4.66927 8.32248 4.66927 12.834C4.66927 17.3455 8.32444 21.0007 12.8359 21.0007C14.9597 21.0036 17.0006 20.1768 18.5234 18.6965L18.6984 18.5215Z"
                                            fill="black" />
                                    </svg>
                        ...
                        <!-- Main Chat Section -->
                        <div class="call-description-con">
                            <!-- Details Section -->
                            <div class="call-left-right">
                                <aside class="calls-detail">

                                    <div class="profile">
                                        <img src="https://res.cloudinary.com/dtjgawrwz/image/upload/v1733821949/chatnoteimg_zbeogu.png" alt="Profile Picture" class="profile-avatar">
                                    ...
                                    <div class="info">
                                        <div class="info-item">
                                            ...
                                            <div class="phone-number">
                                                <div class="number-ch">+91 1233455664</div>
                                                <div class="svg-ch"></div>
                                            </div>
                                        </div>
                                        <div class="info-item">
                                            <strong>Email</strong>
                                            <div class="email">
                                                <div class="number-ch">sauravpriyapati08@gmail.com</div>
                                                <div class="svg-ch"></div>
                                            </div>
                                        </div>
                                        <div class="info-item">
                                            <strong>Note</strong>
                                            <div class="Notes">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                                Adipisci vitae, maxime asperiores alias vel velit cum iusto!</div>
                                        </div>
                                    </div>

                                    <div class="action-buttons">
                                        <button class="icon-button"><svg xmlns="http://www.w3.org/2000/svg" width="38"
                                                height="38" viewBox="0 0 38 38" fill="none">
                                                <path
                                                    d="M31.7152 9.84734L25.7777 3.90984C25.6673 3.7996 25.5363 3.71219 25.3921 3.65259C25.248 3.59299 25.0935 3.56238 24.9375 3.5625H13.0625C12.4326 3.5625 11.8285 3.81272 11.3831 4.25812C10.9377 4.70352 10.6875 5.30761 10.6875 5.9375V8.3125H8.3125C7.68261 8.3125 7.07852 8.56272 6.63312 9.00812C6.18772 9.45352 5.9375 10.0576 5.9375 10.6875V32.0625C5.9375 32.6924 6.18772 33.2965 6.63312 33.7419C7.07852 34.1873 7.68261 34.4375 8.3125 34.4375H24.9375C25.5674 34.4375 26.1715 34.1873 26.6169 33.7419C27.0623 33.2965 27.3125 32.6924 27.3125 32.0625V29.6875H29.6875C30.3174 29.6875 30.9215 29.4373 31.3669 28.9919C31.8123 28.5465 32.0625 27.9424 32.0625 27.3125V10.6875C32.0626 10.5315 32.032 10.377 31.9724 10.2329C31.9128 10.0887 31.8254 9.95771 31.7152 9.84734ZM24.9375 32.0625H8.3125V10.6875H19.6962L24.9375 15.9288V28.4762C24.9375 28.4852 24.9375 28.4926 24.9375 28.5C24.9375 28.5074 24.9375 28.5148 24.9375 28.5238V32.0625ZM29.6875 27.3125H27.3125V15.4375C27.3126 15.2815 27.282 15.127 27.2224 14.9829C27.1628 14.8387 27.0754 14.7077 26.9652 14.5973L21.0277 8.65984C20.9173 8.5496 20.7863 8.46219 20.6421 8.40259C20.498 8.34299 20.3435 8.31238 20.1875 8.3125H13.0625V5.9375H24.4462L29.6875 11.1788V27.3125ZM21.375 22.5625C21.375 22.8774 21.2499 23.1795 21.0272 23.4022C20.8045 23.6249 20.5024 23.75 20.1875 23.75H13.0625C12.7476 23.75 12.4455 23.6249 12.2228 23.4022C12.0001 23.1795 11.875 22.8774 11.875 22.5625C11.875 22.2476 12.0001 21.9455 12.2228 21.7228C12.4455 21.5001 12.7476 21.375 13.0625 21.375H20.1875C20.5024 21.375 20.8045 21.5001 21.0272 21.7228C21.2499 21.9455 21.375 22.2476 21.375 22.5625ZM21.375 27.3125C21.375 27.6274 21.2499 27.9295 21.0272 28.1522C20.8045 28.3749 20.5024 28.5 20.1875 28.5H13.0625C12.7476 28.5 12.4455 28.3749 12.2228 28.1522C12.0001 27.9295 11.875 27.6274 11.875 27.3125C11.875 26.9976 12.0001 26.6955 12.2228 26.4728C12.4455 26.2501 12.7476 26.125 13.0625 26.125H20.1875C20.5024 26.125 20.8045 26.2501 21.0272 26.4728C21.2499 26.6955 21.375 26.9976 21.375 27.3125Z"
                                                    fill="white" />
                                            </svg>Open saved form<svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" viewBox="0 0 16 16" fill="none">
                                                <path
                                                    d="M6.66602 2.66699H3.99935C3.64573 2.66699 3.30659 2.80747 3.05654 3.05752C2.80649 3.30756 2.66602 3.6467 2.66602 4.00033V12.0003C2.66602 12.3539 2.80649 12.6931 3.05654 12.9431C3.30659 13.1932 3.64573 13.3337 3.99935 13.3337H11.9993C12.353 13.3337 12.6921 13.1932 12.9422 12.9431C13.1922 12.6931 13.3327 12.3539 13.3327 12.0003V9.33366M7.99935 8.00033L13.3327 2.66699M13.3327 2.66699V6.00033M13.3327 2.66699H9.99935"
                                                    stroke="white" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg></button>
                                        <button class="copy-btn"><svg xmlns="http://www.w3.org/2000/svg" width="26"
                                                height="28" viewBox="0 0 26 28" fill="none">
                                                <path
                                                    d="M15.25 6.20003V11.4001H19M17.0275 1H10C9.20435 1 8.44129 1.27393 7.87868 1.76153C7.31607 2.24912 7 2.91045 7 3.60001V19.2001C7 19.8897 7.31607 20.551 7.87868 21.0386C8.44129 21.5262 9.20435 21.8001 10 21.8001H22C22.7956 21.8001 23.5587 21.5262 24.1213 21.0386C24.6839 20.551 25 19.8897 25 19.2001V7.81464C25 7.46826 24.92 7.12539 24.765 6.80615C24.6099 6.48691 24.3828 6.19774 24.097 5.95563L19.1245 1.741C18.564 1.26606 17.8114 1.00008 17.0275 1Z"
                                                    stroke="black" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path
                                                    d="M19 21.8001V24.4001C19 25.0897 18.6839 25.751 18.1213 26.2386C17.5587 26.7262 16.7956 27.0001 16 27.0001H4C3.20435 27.0001 2.44129 26.7262 1.87868 26.2386C1.31607 25.751 1 25.0897 1 24.4001V10.1C1 9.41045 1.31607 8.74912 1.87868 8.26153C2.44129 7.77393 3.20435 7.5 4 7.5H7"
                                                    stroke="black" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg></button>
                                    </div>
                                </aside>
                                <div class="call-right-history">
                                    <div class="outervoicecall">
                                        <div class="call-container">
                                            <!-- Profile Image -->
                                            <img src="https://res.cloudinary.com/dtjgawrwz/image/upload/v1733821953/consultingimg1_bk5jfv.png" alt="Profile Image" class="profile-image">

                                            <!-- Call Status -->
                                            <p class="call-status">Voice call</p>

                                            <!-- Call Timer -->
                                            <p class="call-timer">01:09</p>

                                            <!-- Username -->
                                            <p class="username">Urvashi Kumari</p>

                                            <!-- Action Buttons -->
                                            <div class="button-containers">
                                                <div class="action-button mute-button">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                        viewBox="0 0 25 25" fill="none">
                                                        <path
                                                            d="M22.2656 8.98438L16.7969 16.0156M16.7969 8.98438L22.2656 16.0156M2.73438 8.98438V16.0156H6.64062L12.8906 20.7031V4.29688L6.64062 8.98438H2.73438Z"
                                                            stroke="black" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                    </svg>
                                                </div>
                                                <div class="action-button end-call-button">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24"
                                                        viewBox="0 0 22 24" fill="none">
                                                        <path
                                                            d="M18.2188 4.125L13.4062 9.375M13.4062 4.125L18.2188 9.375M2.40625 2.625C2.40625 15.375 7.90625 21.375 19.5938 21.375V15.375L14.7812 13.875L13.4062 16.125C10.6562 16.125 7.21875 12.375 7.21875 9.375L9.28125 7.875L7.90625 2.625H2.40625Z"
                                                            stroke="black" stroke-width="2.25" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                    </svg>
                                                </div>
                                                <div class="action-button speaker-button">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                        viewBox="0 0 25 25" fill="none">
                                                        <path
                                                            d="M22.2656 8.98438L16.7969 16.0156M16.7969 8.98438L22.2656 16.0156M2.73438 8.98438V16.0156H6.64062L12.8906 20.7031V4.29688L6.64062 8.98438H2.73438Z"
                            ...
                            <div class="outer-audio-history">
                                <div class="call-history-container">
                                    ...
                                    <div class="call-item">
                                        <div class="call-info">
                                            <span class="call-time">1:46 PM</span>
                                            <div class="call-number">
                                                <span>+91 2323445664</span>
                                                <span class="call-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                        width="15" height="14" viewBox="0 0 15 14" fill="none">
                                                        <path
                                                            d="M9.85156 4.75L12.8516 1.75M12.8516 1.75V4M12.8516 1.75H10.6016"
                                                            stroke="#26FF00" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path
                                                            d="M10.2685 8.91104L9.9272 9.27104C9.9272 9.27104 9.11495 10.1253 6.8987 7.79204C4.68245 5.45879 5.4947 4.60454 5.4947 4.60454L5.70995 4.37729C6.23945 3.81929 6.2897 2.92379 5.82695 2.26979L4.88195 0.932536C4.30895 0.122536 3.2027 0.0160364 2.54645 0.706786L1.3697 1.94504C1.04495 2.28779 0.827454 2.73104 0.853705 3.22379C0.921204 4.48379 1.4597 7.19354 4.4627 10.3563C7.64795 13.7088 10.6367 13.8423 11.8585 13.7215C12.2455 13.684 12.5815 13.4748 12.8522 13.1898L13.9172 12.0678C14.6372 11.3103 14.4347 10.0128 13.5137 9.48329L12.0812 8.65829C11.4767 8.31104 10.741 8.41304 10.2685 8.91029"
                                                            fill="#26FF00" />
                                                    </svg></span>
                                            </div>
                                        </div>
                                        <div class="audio-info">
                                            ...
                                            <span class="audio-duration">3:43</span>
                                        </div>
                                        <div class="call-status Incoming">
                                            <span>Incoming: 3m 43s</span>
                                            <span>➔</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="call-item">
                                        <div class="call-info">
                                            ...
                                            <div class="call-number">
                                                <span>+91 2323445664</span>
                                                <span class="call-icon missed"><svg xmlns="http://www.w3.org/2000/svg"
                                                        width="15" height="14" viewBox="0 0 15 14" fill="none">
                                                        <path
                                                            d="M12.8555 1.74902L9.85547 4.74902L12.8555 1.74902ZM9.85547 4.74902V2.49902V4.74902ZM9.85547 4.74902H12.1055H9.85547Z"
                                                            fill="#FF0000" />
                                                        <path
                                                            d="M12.8555 1.74902L9.85547 4.74902M9.85547 4.74902V2.49902M9.85547 4.74902H12.1055"
                                                            stroke="#FF0000" stroke-width="0.8" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <mask id="path-3-inside-1_3279_16992" fill="white">
                                                            <path
                                                                d="M10.2724 8.91006L9.93111 9.27006C9.93111 9.27006 9.11886 10.1243 6.90261 7.79106C4.68636 5.45781 5.49861 4.60356 5.49861 4.60356L5.71386 4.37631C6.24336 3.81831 6.29361 2.92281 5.83086 2.26881L4.88586 0.93156C4.31286 0.12156 3.20661 0.0150598 2.55036 0.70581L1.37361 1.94406C1.04886 2.28681 0.831361 2.73006 0.857611 3.22281C0.925111 4.48281 1.46361 7.19256 4.46661 10.3553C7.65186 13.7078 10.6406 13.8413 11.8624 13.7206C12.2494 13.6831 12.5854 13.4738 12.8561 13.1888L13.9211 12.0668C14.6411 11.3093 14.4386 10.0118 13.5176 9.48231L12.0851 8.65731C11.4806 8.31006 10.7449 8.41206 10.2724 8.90931" />
                                                        </mask>
                                                        <path
                                                            d="M10.2724 8.91006L9.93111 9.27006C9.93111 9.27006 9.11886 10.1243 6.90261 7.79106C4.68636 5.45781 5.49861 4.60356 5.49861 4.60356L5.71386 4.37631C6.24336 3.81831 6.29361 2.92281 5.83086 2.26881L4.88586 0.93156C4.31286 0.12156 3.20661 0.0150598 2.55036 0.70581L1.37361 1.94406C1.04886 2.28681 0.831361 2.73006 0.857611 3.22281C0.925111 4.48281 1.46361 7.19256 4.46661 10.3553C7.65186 13.7078 10.6406 13.8413 11.8624 13.7206C12.2494 13.6831 12.5854 13.4738 12.8561 13.1888L13.9211 12.0668C14.6411 11.3093 14.4386 10.0118 13.5176 9.48231L12.0851 8.65731C11.4806 8.31006 10.7449 8.41206 10.2724 8.90931"
                                                            fill="#FF0000" />
                                                        <path
                                                            d="M9.93111 9.27006L10.3176 9.63756L10.3182 9.63697L9.93111 9.27006ZM5.49861 4.60356L5.88512 4.97106L5.88582 4.97032L5.49861 4.60356ZM5.71386 4.37631L5.32699 4.0092L5.32665 4.00955L5.71386 4.37631ZM5.83086 2.26881L5.39531 2.5766L5.39549 2.57686L5.83086 2.26881ZM4.88586 0.93156L5.32141 0.623765L5.32126 0.623552L4.88586 0.93156ZM2.55036 0.70581L2.93696 1.07321L2.93702 1.07315L2.55036 0.70581ZM1.37361 1.94406L0.987008 1.57666L0.986458 1.57724L1.37361 1.94406ZM0.857611 3.22281L0.325033 3.25118L0.325041 3.25134L0.857611 3.22281ZM4.46661 10.3553L4.07985 10.7225L4.07997 10.7227L4.46661 10.3553ZM11.8624 13.7206L11.8109 13.1897L11.8099 13.1898L11.8624 13.7206ZM12.8561 13.1888L13.2428 13.5561L13.2429 13.556L12.8561 13.1888ZM13.9211 12.0668L13.5345 11.6994L13.5343 11.6996L13.9211 12.0668ZM13.5176 9.48231L13.2514 9.94448L13.2518 9.94468L13.5176 9.48231ZM12.0851 8.65731L12.3513 8.19514L12.3508 8.19485L12.0851 8.65731ZM9.88529 8.54315L9.54404 8.90315L10.3182 9.63697L10.6594 9.27697L9.88529 8.54315ZM9.93111 9.27006C9.54461 8.90256 9.54509 8.90205 9.54558 8.90154C9.54574 8.90137 9.54622 8.90087 9.54654 8.90053C9.54718 8.89987 9.5478 8.89922 9.54843 8.89858C9.54967 8.8973 9.55088 8.89607 9.55206 8.89488C9.55442 8.89251 9.55665 8.89031 9.55876 8.88828C9.56299 8.88421 9.56672 8.8808 9.56996 8.87796C9.57643 8.87229 9.58099 8.86885 9.58357 8.86702C9.58886 8.86328 9.58608 8.86614 9.57413 8.87084C9.5546 8.87854 9.48106 8.9031 9.33358 8.87911C9.02227 8.82847 8.36517 8.55642 7.2893 7.42376L6.51592 8.15836C7.6563 9.35895 8.51345 9.8264 9.16233 9.93194C9.49495 9.98605 9.76298 9.94288 9.96501 9.86331C10.0638 9.82439 10.1418 9.77874 10.2002 9.7374C10.2293 9.71677 10.2535 9.69725 10.2729 9.68021C10.2827 9.67168 10.2912 9.66376 10.2987 9.6566C10.3024 9.65303 10.3058 9.64964 10.309 9.64646C10.3105 9.64487 10.3121 9.64333 10.3135 9.64185C10.3142 9.6411 10.3149 9.64038 10.3156 9.63966C10.316 9.63931 10.3165 9.63878 10.3166 9.6386C10.3171 9.63808 10.3176 9.63756 9.93111 9.27006ZM7.2893 7.42376C6.21661 6.29443 5.94846 5.59501 5.89722 5.24508C5.87244 5.07583 5.8974 4.98429 5.90873 4.95248C5.91497 4.93497 5.91954 4.92875 5.91714 4.93249C5.91599 4.93429 5.91318 4.93846 5.90807 4.94491C5.90552 4.94813 5.90239 4.95193 5.89859 4.95629C5.89669 4.95847 5.89463 4.96079 5.89239 4.96325C5.89127 4.96448 5.8901 4.96575 5.88889 4.96705C5.88828 4.9677 5.88767 4.96836 5.88704 4.96903C5.88672 4.96936 5.88624 4.96987 5.88609 4.97004C5.8856 4.97055 5.88512 4.97106 5.49861 4.60356C5.11211 4.23606 5.11161 4.23658 5.11112 4.2371C5.11095 4.23728 5.11045 4.23781 5.11011 4.23817C5.10943 4.23889 5.10874 4.23963 5.10804 4.24038C5.10663 4.24189 5.10518 4.24347 5.10367 4.24512C5.10067 4.24842 5.09747 4.25201 5.09411 4.25587C5.08737 4.26361 5.07995 4.27249 5.07199 4.28254C5.05606 4.30264 5.03797 4.32744 5.01894 4.35715C4.98078 4.41673 4.9392 4.49548 4.90392 4.59451C4.83222 4.79578 4.79262 5.06364 4.84181 5.3996C4.93851 6.06011 5.37237 6.95444 6.51592 8.15836L7.2893 7.42376ZM5.88582 4.97032L6.10107 4.74307L5.32665 4.00955L5.1114 4.2368L5.88582 4.97032ZM6.10073 4.74342C6.81553 3.99016 6.86738 2.81036 6.26623 1.96076L5.39549 2.57686C5.71984 3.03526 5.67119 3.64646 5.32699 4.0092L6.10073 4.74342ZM6.26641 1.96101L5.32141 0.623765L4.45031 1.23935L5.39531 2.5766L6.26641 1.96101ZM5.32126 0.623552C4.56995 -0.438507 3.06993 -0.615397 2.1637 0.338466L2.93702 1.07315C3.3433 0.645517 4.05577 0.681627 4.45046 1.23957L5.32126 0.623552ZM2.16376 0.338409L0.987009 1.57666L1.76021 2.31146L2.93696 1.07321L2.16376 0.338409ZM0.986458 1.57724C0.589276 1.99644 0.289059 2.5759 0.325033 3.25118L1.39019 3.19444C1.37366 2.88422 1.50845 2.57718 1.76076 2.31088L0.986458 1.57724ZM0.325041 3.25134C0.39901 4.6321 0.985547 7.46363 4.07985 10.7225L4.85338 9.98808C1.94167 6.92149 1.45121 4.33352 1.39018 3.19428L0.325041 3.25134ZM4.07997 10.7227C7.39504 14.2118 10.5547 14.3857 11.9148 14.2513L11.8099 13.1898C10.7265 13.2969 7.90868 13.2038 4.85326 9.98795L4.07997 10.7227ZM11.9138 14.2514C12.4668 14.1978 12.9142 13.902 13.2428 13.5561L12.4694 12.8215C12.2565 13.0456 12.0319 13.1683 11.8109 13.1897L11.9138 14.2514ZM13.2429 13.556L14.3079 12.434L13.5343 11.6996L12.4693 12.8216L13.2429 13.556ZM14.3077 12.4342C15.2739 11.4177 14.9936 9.71568 13.7834 9.01994L13.2518 9.94468C13.8836 10.3079 14.0083 11.2009 13.5345 11.6994L14.3077 12.4342ZM13.7838 9.02014L12.3513 8.19514L11.8189 9.11948L13.2514 9.94448L13.7838 9.02014ZM12.3508 8.19485C11.5382 7.7281 10.5319 7.86194 9.88574 8.54193L10.659 9.27669C10.9578 8.96218 11.423 8.89202 11.8195 9.11977L12.3508 8.19485Z"
                                                            fill="#FF0000" mask="url(#path-3-inside-1_3279_16992)" />
                                                    </svg></span>
                                            </div>
                                        </div>
                                        <div class="audio-info">
                                            ...
                                            <span class="audio-duration">1:23</span>
                                        </div>
                                        <div class="call-status">
                                            <span class="status-icon">⚠️</span>
                                            <span>didn’t connect</span>
                                            <span>➔</span>
                                        </div>
                                    </div>
                                    <div class="call-item">
                                    ...
                                    <!-- Repeat more call items as needed -->
...
<script>
    //         const chatBtn = document.querySelector('.client-for-chat');
    // const descriptionCon = document.querySelector('.call-description-con');
    // const hidechatid=document.querySelector('.chat-sidebar');

    // chatBtn.addEventListener('click', () => {
    //   chatBtn.style.display = 'none';
    //   hidechatid.style.display="none";
    //   descriptionCon.style.display = 'block';
    // });
</script>
<script src="dashboard.js"></script>
