...
<div class="contact-container">
    ...
    <div class="contact-details">
        <h2>Contact Us</h2>
        <p>Email, Call or complete the form to leave how a visa expert can solve your messaging or visa problems.
        </p>
        <a href="mailto:support@visaexperts.com">Support@visaexperts.com</a>
        <div class="phone-numbers">
            <a href="tel:+919711000022">+91 9711000022</a>
            <a href="tel:+911204502750">+91 0120-4502750</a>
        </div>
        <a href="mailto:customersupport@visaexperts.com">CustomerSupport@visaexperts.com</a>
        <h3>Feedback And Suggestions</h3>
        <p>We value your feedback and are continuously working to improve the visa experts service. Your input is
            crucial in shaping the future of visa experts.</p>
    </div>
    ...
    <div class="form-section">
        ...
        <form>
            ...
            <textarea placeholder="Enter your Query" rows="4" required></textarea>
            <button type="submit">Submit</button>
            <div class="consent-checkbox">
                <input type="checkbox" required>
                <label>By contacting us, you agree to our terms of service and privacy policy.</label>
            </div>
        </form>
    </div>
</div>
...
<!-- //Second last and Footer Element -->
<section class="app-banner">
    <div class="app-banner-intro">
        <h1>Our mobile app is coming soon!</h1>
        <p>Get ready to simplify your visa application process with easy access to information, real-time updates, and personalized support—all in the palm of your hand.</p>
    </div>
...
<footer class="site-footer">
    <div class="footer-wrapper">
        <div class="footer-section footer-logo-section">
            ...
            <p>Visa Expert helps individuals secure visas for the USA, Canada, and Australia. Our experienced team offers personalized guidance, ensuring a smooth application process for tourist, student, and work visas.</p>
        </div>
